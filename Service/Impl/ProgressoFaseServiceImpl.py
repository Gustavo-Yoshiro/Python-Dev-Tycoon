from Service.ProgressoFaseService import ProgressoFaseService
from Persistencia.Impl.ProgressoFasePersistenciaImpl import ProgressoFasePersistenciaImpl
