# Importe todas as classes de Serviço, Entidade e o gerenciador do Banco
...
def popular_projetos(projeto_service):
    ...
    # --- PROJETO 1: Calculadora de Café ---
    proj1 = ProjetoFreelance(
        id_projeto=None, id_cliente=4, titulo='Calculadora de Café', 
        descricao='Função que multiplica preço pela quantidade.', 
        dificuldade='Iniciante', recompensa=100.00, status='disponivel', 
        req_backend=1, req_frontend=1, req_social=1, tags='Básico, Matemática', 
        data_postagem=None,
        prazo_dias=2, tipo_desafio='completar',
    ...
    projeto_service.criar_projeto(proj1)
    
    # --- PROJETO 2: Medidor de Dano ---
    proj2 = ProjetoFreelance(
        id_projeto=None, id_cliente=3, titulo='Medidor de Dano', 
        descricao='A função de dano crítico está com um bug.', 
        dificuldade='Iniciante', recompensa=300.00, status='disponivel', 
        req_backend=2, req_frontend=1, req_social=2, tags='Lógica, Condicionais', 
        data_postagem=None,
        prazo_dias=3, tipo_desafio='debug',
    ...
    projeto_service.criar_projeto(proj2)
...
if __name__ == "__main__":
    ...
    # Garante que a estrutura do banco de dados está criada
