...
class DialogoNoPersistenciaImpl(DialogoNoPersistencia):
    ...
    def salvar(self, no: DialogoNo) -> DialogoNo:
    ...
    def buscar_no_inicial(self, id_projeto: int) -> DialogoNo:
    ...
    def buscar_por_id(self, id_no: int) -> DialogoNo:
...
class DialogoOpcaoPersistenciaImpl(DialogoOpcaoPersistencia):
    ...
    def salvar(self, opcao: DialogoOpcao) -> DialogoOpcao:
        sql = """
    ...
    def buscar_opcoes_por_no_origem(self, id_no_origem: int) -> list:
